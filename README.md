...
[Transplant Linux_Driver_Tutorial for JetsonNano from Johannes4Linux]
...
1. Simple Kernel Module[Done]
2. Device Numbers and Device Files[Done]
3. Create device file in driver and callbacks[Done]
4. GPIO Driver
5. Text LCD Driver
6. PWM Module
7. Temperature Sensor (I2C)
8. Timer in Linux Kernel Modules[Done]
9. High Resolution Timer in Linux Kernel Modules[Done]
...
80. hrtimer -> userspace callback timer
